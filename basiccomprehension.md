...
The [Tool Analysis Result Sheet](https://jpcertcc.github.io/ToolAnalysisResultSheet/) covers **49** different **Windows-Native tools** "which are likely to be used by the attacker that has infiltrated a network."
